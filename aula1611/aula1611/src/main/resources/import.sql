...
insert into tb_compromissos(local_id,contato_id ,data ,hora ,status)values(1,1,'2023-12-06','0.5','A');
insert into tb_compromissos(local_id ,contato_id ,data ,hora ,status)values(2,2,'2023-12-07','8.5','A');
insert into tb_compromissos(local_id ,contato_id ,data ,hora ,status)values(3,2,'2023-12-08','7.5','A');